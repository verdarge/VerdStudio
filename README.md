...
VERD is a high-level programming language designed to ease ERP development and database reporting. Unique features that VERD language has make it both high level and near as fast as **C** .
